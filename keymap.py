...
def register():
    ...
    if kc:
        ...
        if True:
            ...
            km.keymap_items.new('Target Move Start', 'G', 'PRESS')
            km.keymap_items.new('Target Center Reset', 'G', 'PRESS', alt=True)
            km.keymap_items.new('Target Move X Axis', 'X', 'PRESS')
            km.keymap_items.new('Target Move Y Axis', 'Y', 'PRESS')
            km.keymap_items.new('Target Move Z Axis', 'Z', 'PRESS')

            km.keymap_items.new(
                'Confirm Tool 1', 'LEFTMOUSE', 'PRESS', any=True)
